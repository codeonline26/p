...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'unnamed-file.zip_0854a2d4a6d3ee311931_20230914222823_archive.zip';
        const ARCHIVE_SIZE       = '60024851';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '0854a2d-14222823';
        const SECONDARY_PACKAGE_HASH = '1c85d64-14222823';
